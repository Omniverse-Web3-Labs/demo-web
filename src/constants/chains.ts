...
export const sepolia: Chain = {
  ...
  rpcUrls: {
    default: {
      http: ['https://bsc.getblock.io/f19d7993-2e1e-44eb-a48e-bc55356c5e78/testnet/'],
      webSocket: ['wss://eth.getblock.io/f19d7993-2e1e-44eb-a48e-bc55356c5e78/sepolia/'],
    },
    public: {
      http: ['https://bsc.getblock.io/f19d7993-2e1e-44eb-a48e-bc55356c5e78/testnet/'],
      webSocket: ['wss://eth.getblock.io/f19d7993-2e1e-44eb-a48e-bc55356c5e78/sepolia/'],
...
export const chains = [platON, mumbai];
